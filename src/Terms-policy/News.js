...
function News() {
  return (
    <>
      <div class="pt-8 pb-16 lg:pt-16 lg:pb-24 mt-28">
        <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
          <div class="mx-auto w-full format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
            ...
            <p class="lead">
              open-source library of UI components built with the
            ...
            <h2>Getting started with us</h2>
            <p>
              First of all you need to understand how its works. This
            ...
            <p>
              ...
              project. But if you want to build a project with  I
            ...
            <blockquote>
              <p>
                It is just awesome. It contains tons of predesigned
