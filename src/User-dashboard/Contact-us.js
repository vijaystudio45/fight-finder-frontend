...
import { usercontactAction } from "../Redux/Action/User-contact-us-action";
...
const Contact_Page = () => {
  ...
  const { success, error, loading } = useSelector(
    (state) => state.usercontactSendReducer
  );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <div className="relative z-10 overflow-hidden bg-white contactuspage">
            <div className="about_image  mt-28">
              <div className="Home-events-img11 Publiceventde">
                <div className="welcome-event-home">
                  <h4 className="pagetitleall">Contact us</h4>
            ...
            <div className="container mx-auto">
              <div className="-mx-2 py-4 flex flex-wrap lg:justify-between mt-12 mb-12 ">
                <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                  <div className="mb-12 max-w-[570px] lg:mb-0">
                    <h2 className="text-dark mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[30px]">
                ...
                <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
                  <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                    <form onSubmit={validateSubmit}>
                      <div
                        className={
                          errors.name ? "inputCntnr error" : "inputCntnr"
                        }
                      >
                        <div className="mb-6">
                          <input
                      ...
                      <div
                        className={
                          errors.message ? "inputCntnr error" : "inputCntnr"
                        }
                      >
                        <div className="mb-6">
                          <textarea
