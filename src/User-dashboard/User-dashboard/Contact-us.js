...
const submitConatctdata =()=>{
  ...
  return (
    <>
      <LoaderSpinner />
      <div class="relative z-10 overflow-hidden bg-white py-4">
        <div className="about_image mb-4">
          <div className="Home-events-img relative">
            <img className="w-100" src="/img/kendo ready 1222.png" />
            <div className="heading-contnet-fight container absolute">
              <h4 className="text-white sm:text-5xl lg:text-6xl  font-black uppercase">
                Contact us
              </h4>
            </div>
          </div>
        ...
        <div class="container mx-auto">
          <div class="-mx-2 flex flex-wrap lg:justify-between">
            <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div class="mb-12 max-w-[570px] lg:mb-0">
                <h2 class="text-dark mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[30px]">
                ...
                <div class="mb-8 flex w-full max-w-[370px]">
                  <div class="bg-primary text-white mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                  ...
                  <div class="w-full">
                    ...
                    <p class="text-body-color text-base">
                      <a href="fightfinder@gmail.com">
                        {getcontactdetails?.[0]?.email}
                      </a>
                    </p>
                  </div>
                </div>
